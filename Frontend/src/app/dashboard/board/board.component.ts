...
export class BoardComponent implements OnInit {
  ...
  //         {
  //         taskId:3,
  //         taskName:"Develop new api Checkout Experiance",
  //         taskDescription:"Lorem ipsum dolor",
  //         taskImage:"",
  //         taskAssignedTo:"harshal.karande1998@gmail.com",
  ...
  //         {
  //           taskId:4,
  //           taskName:"Event Tracking for checkout Pages",
  //           taskDescription:"task 3",
  //           taskImage:"",
  //           taskAssignedTo:"raghav@gmail.com",
  //           taskCompletionStatus:false,
  //           taskPriority:"",
  //           taskStatus:"",
  //           dueDate:new Date()
  ...
  //         {
  //         taskId:3,
  //         taskName:"Design new wireframe for new checkout experiaance",
  //         taskDescription:"task 2",
  //         taskImage:"",
  //         taskAssignedTo:"bsk@gmail.com",
  ...
  //         {
  //         taskId:3,
  //         taskName:"Add share at button in browse screen ",
  //         taskDescription:"task 2",
  //         taskImage:"",
  //         taskAssignedTo:"someone_not_raghav@gmail.com",
  //         taskCompletionStatus:true,
  //         taskPriority:"high",
  //         taskStatus:"on-track",
  //         dueDate:new Date()
  ...
  //     // }
  //   ],
  //   availableTaskPriority:["low", "medium","high"],
  //   availableTaskStatus:["on-track","at-risk"]
      ...
      if(this.memberTransfer.isMemberAdded)
      {
        ...
        this.userBoard.addBoardUser(this.boardObject.boardId,newMember.memberEmail).subscribe({
          ...
          error: err=>{
            ...
            this.snackbarService.openSnackBar("This Email is not registere with HRS kanban board ","Dismiss")
            console.log(err);
